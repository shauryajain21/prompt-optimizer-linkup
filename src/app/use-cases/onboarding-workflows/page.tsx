      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-3xl font-bold text-linkup-text mb-4">
                How to build personalized onboarding workflows with Linkup
              </h1>
              <p className="text-lg text-linkup-text-muted leading-relaxed">
                Create personalized onboarding experiences by researching new users, customers, or employees.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-12 text-center">
          <div className="w-20 h-20 bg-linkup-cream rounded-full flex items-center justify-center mx-auto mb-6">
            <TargetIcon className="w-10 h-10 text-linkup-text-light" />
          </div>
          ...
          <p className="text-linkup-text-muted max-w-md mx-auto mb-8">
            We&apos;re working on a comprehensive guide for building personalized onboarding workflows with Linkup. Check back soon for detailed examples, prompts, and schemas.
          </p>
